...
public class JwtOperator {
     ...
     * 秘钥
     */
    @Value("${jwt.secret:991ef007ae91853fa756537a7724013e}")
...
//        objectObjectHashMap.put("nickname", "mqxu");
...
//        System.out.println(token);
        ...
        // 将这串字符还原为上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJuaWNrbmFtZSI6Im1xeHUiLCJpZCI6IjEiLCJpYXQiOjE2NjQ4NjgyNzgsImV4cCI6MTY2NjA3Nzg3OH0.-1H5_gzJyUlHBV3ElILpIU_eF9caHBZO-4nu0xTdHDU";
...
//        System.out.println(new String(header));
        //
        // token的第二段（以.为边界）
//        String encodedPayload = "eyJuaWNrbmFtZSI6Im1xeHUiLCJpZCI6IjEiLCJpYXQiOjE2NjQ4NjgyNzgsImV4cCI6MTY2NjA3Nzg3OH0";
        ////// 测试5: 解密Payload
//        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
//        System.out.println(new String(payload));
        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
        boolean flag = jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJuaWNrbmFtZSI6Im1xeHUiLCJpZCI6IjEiLCJpYXQiOjE2NjQ4NjgyNzgsImV4cCI6MTY2NjA3Nzg3OH0.-1H5_gzJyUlHBV3ElILpIU_eF9caHBZO-4nu0xTdHDU");
